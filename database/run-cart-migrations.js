...
async function runMigrations() {
  ...
  try {
    ...
    const cartMigrationPath = join(__dirname, 'migrations', '002_add_cart_table.sql');
    ...
    const savedMigrationPath = join(__dirname, 'migrations', '005_add_saved_for_later.sql');
